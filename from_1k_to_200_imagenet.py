...
ids_to_200 = {k for k in imagenet_1k.keys() if thousand_k_to_200[k] != -1}

names_to_200 = {imagenet_1k[k]: thousand_k_to_200[k] for k in ids_to_200}

i = 1
for k in names_to_200:
    print(i, " : \"",  k, "\"")
    i += 1